...
public class AddressController {
    ...
    public ResponseEntity<String> createAddress(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Details of the address to be created")
                                                    @RequestBody(required = true) @Valid CustomerAddressDTO address) {
    ...
    public ResponseEntity<String> updateAddress(@Parameter(description = "ID of the address that is supposed to be updated") @RequestParam(required = true) Integer addressId,
        ...
        addressService.updateAddress(addressId, street, city, zipCode, stateId);
