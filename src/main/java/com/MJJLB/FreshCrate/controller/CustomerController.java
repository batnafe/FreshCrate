...
public class CustomerController {
    ...
    public ResponseEntity<List<CustomerDTO>> getCustomer(@Parameter(description = "ID of the customer") @RequestParam(required = false) Integer customerId,
    ...
    public ResponseEntity<String> updateCustomerEmail(@Parameter(description = "ID of the customer whose email is to be updated") @RequestParam(required = true) int id,
    ...
    public ResponseEntity<String> updateCustomerPhoneNumber(@Parameter(description = "ID of the customer whose phone number is to be updated") @RequestParam(required = true) int id,
    ...
    public ResponseEntity<String> deleteCustomer(@Parameter(description = "ID of the customer to be deleted") @RequestParam(required = true) int id) {
